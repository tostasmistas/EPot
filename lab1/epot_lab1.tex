...
\unsure{tenho de explicar porque nao respondemos à pergunta 5?}
...
A forma dos sinais de corrente e tensão no díodo em antiparalelo podem ser observadas na \todo{INSERIR FIGURA 2} sendo a corrente representada a rosa e a tensão a amarelo.
...
Em \todo{inserir figura 3} pode ver-se a tensão no tiristor a amarelo e a corrente a rosa.
...
\todo{Temos que magicar esta imagem de alguma forma}
