...
A tensão de Zenner tem um valor de $-17$ V em oposição à tensão V\textsubscript{AK} de um díodo normal, $0,7$ V, o que leva a uma dissipação muito mais rápida e por consequência acelera o processo de desmagnetização. \change{explicar areas iguais}
