...
\begin{figure}[h]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.6]{img/cicruitorl}
...
\begin{figure}[h]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.3]{img/lacunar}
...
\begin{figure}[h]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.35]{img/bbbobine}
...
\begin{figure}[h]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.35]{img/bbdiode}
